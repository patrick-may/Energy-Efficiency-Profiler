"""
Testing a Couple Different Sorts With CowProf

All Sorting Code was grabbed directly from GeeksForGeeks Tutorials
"""
...
def gen_scramble(size):
    import random
    # cast to list to avoid generator wackness
    return list(
